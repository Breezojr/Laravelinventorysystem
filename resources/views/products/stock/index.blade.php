...
<div class="header bg-primary pb-6">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('stocks.create') }}" class="btn btn-sm btn-neutral">New</a>
 ...
 <!-- Dark table -->
        ...
        <tr>
            <td>{{ ++$i }}</td>
            <td>{{ $value->stores_store_name }}</td>
            <td>{{ $value->stores_store_city }}</td>
            <td>{{ $value->product_name }}</td>
            <td>{{ $value->products_brand_name }}</td>
            ...
            <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('stocks.show',$value->id) }}">Show</a>
                          <a class="dropdown-item" href="{{ route('stocks.edit',$value->id) }}">Edit</a>
