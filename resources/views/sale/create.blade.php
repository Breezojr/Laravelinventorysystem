...
<div class="col">
          ...
          <div class="row align-items-center">
            <div class="col">
              <h2 class="text-black mb-0">Add Sales</h2>
            </div>
            <div class="col">
     ...
     <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="sales_date" class="form-control" placeholder="Enter Purchase date">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Purchase status</strong> 
                <input type="text" name="sales_status" class="form-control" placeholder="Enter Saales status">
            </div>
        </div>
