        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{ route('orders.create') }}" class="btn btn-sm btn-neutral">New</a>
              ...
              <table class="table align-items-center table-dark table-flush">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col" class="sort" data-sort="name">Required date</th>
                    <th scope="col" class="sort" data-sort="name">Shipped date</th>
                    <th scope="col" class="sort" data-sort="name">Order status</th>
                    <th scope="col"></th>
                  </tr>
                </thead>
                <tbody class="list">
            ...
            <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="{{ route('orders.show',$value->id) }}">Show</a>
                          <a class="dropdown-item" href="{{ route('orders.edit',$value->id) }}">Edit</a>
